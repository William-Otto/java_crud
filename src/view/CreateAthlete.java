...
public class CreateAthlete extends JFrame{
	...
	private void createButtons() {
		Button buttonSave = new Button("Salvar", COLOR_BLUE_DARK);
		Button buttonClear = new Button("Limpar", COLOR_BLUE_LIGHT);
	...
	private void addAthleteToDataBase() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Erro ao inserir atleta - " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
		}
